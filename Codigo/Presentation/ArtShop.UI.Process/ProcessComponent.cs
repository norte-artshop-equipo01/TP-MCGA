    ...
    public abstract class ProcessComponent
    {
        ...
        public static T HttpPost<T>(string path, T value, string mediaType)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var response = client.PostAsJsonAsync<T>(pathAndQuery, value).Result;
                response.EnsureSuccessStatusCode();
                result = response.Content.ReadAsAsync<T>().Result;
            }
            return result;
        ...
        public static T HttpPut<T>(string path, T value, string mediaType)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var response = client.PutAsJsonAsync<T>(pathAndQuery, value).Result;
                response.EnsureSuccessStatusCode();
                result = response.Content.ReadAsAsync<T>().Result;
            }
            return result;
        ...
        public static T HttpDelete<T>(string path, T value, string mediaType)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue(mediaType));
                client.DeleteAsync
                var response = client.DeleteAsJsonAsync<T>(pathAndQuery, value).Result;
                response.EnsureSuccessStatusCode();
                result = response.Content.ReadAsAsync<T>().Result;
            }
            return result;
